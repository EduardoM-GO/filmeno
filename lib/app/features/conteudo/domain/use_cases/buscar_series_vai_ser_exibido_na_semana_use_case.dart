...
abstract interface class BuscarSeriesVaiSerExibidoNaSemanaUseCase {
  Future<Result<List<Serie>, Falha>> call();
}

final class BuscarSeriesVaiSerExibidoNaSemanaUseCaseImpl
    extends ObterImagemConteudosUseCase<Serie>
    implements BuscarSeriesVaiSerExibidoNaSemanaUseCase {
  ...
  Future<Result<List<Serie>, Falha>> call() async {
    final result = await _repository.buscarVaiSerExibidoNaSemana();
    if (result.isError()) {
